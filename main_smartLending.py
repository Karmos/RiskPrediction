...
def main():
    ...
    plot_confusion_matrix(y_test, y_pred_svm, 'SVM_smartLending')
    ...
    plot_confusion_matrix(y_test, y_pred_lr, 'logisticRegression_smartLending')
    ...
    # Step 4: SHAP
    analyze_rf_model(X_train_copy, X_test_copy, ['0', '1'], 'randomForest_smartLending')
