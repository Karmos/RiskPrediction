...
def main():
    ...
    save_grid_search_results(grid_results, ['param_n_estimators', 'param_max_depth', 'param_min_samples_leaf', 'mean_test_score', 'std_test_score'], 'results/creditRisk/rf_results.csv')
    ...
    save_grid_search_results(grid_results,
                             ["param_n_estimators", "param_learning_rate", "param_max_depth", "param_subsample",
                              "mean_test_score", "std_test_score", "rank_test_score"], "results/creditRisk/xgb_results.csv")
